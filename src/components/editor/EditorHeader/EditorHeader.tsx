    ...
    <header className="bg-white shadow-sm border-b p-4">
      <div className="flex items-center max-w-7xl mx-auto w-full gap-4">
        <input
          ...
          className="flex-1 min-w-0 text-2xl font-bold px-3 py-2 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
